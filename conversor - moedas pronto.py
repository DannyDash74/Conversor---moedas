...
API_KEY = "552f09aff92077dd07766766"
...
moeda_destino = input('Qual é a moeda destino: ').upper()
...
if valor_convertido is not None:
    print(f"\n{valor:.2f} {moeda_origem} equivalem a {valor_convertido:.2f} {moeda_destino}")
else:
    print("Moedas inválidas. Verifique os códigos informados.")
